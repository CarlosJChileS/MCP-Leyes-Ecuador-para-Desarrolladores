...
export function renderAuditReportSarif(report: AuditReport, dependencyScan?: DependencyScanReport): string {
  ...
  return JSON.stringify({ version: '2.1.0', $schema: 'https://json.schemastore.org/sarif-2.1.0.json', runs: [{ tool: { driver: { name: 'leyes-ecuador-dev-mcp', informationUri: 'https://github.com/CarlosJChileS/leyes-ecuador-dev-mcp' } }, results }] }, null, 2);
}
